# Lespa Portfolio Restructure — Copy
**Status: In progress, locked section by section · Companion to lespa-restructure-structure-and-motion.md**
...
## 3. SELECTED WORK — LOCKED (6 projects)
...
**Tools (under photo, left side)**

*Design Tools:* Adobe Photoshop · Adobe Illustrator · Adobe InDesign · Affinity · Canva · Figma

*Development Tools:* HTML / CSS / JavaScript · React / Next.js · Tailwind CSS · Flutter · XAMPP · Firebase / Supabase

## 7. CONTACT — LOCKED

**Intro line above the form:**
Have something to design/build? Tell me about it.
...
- Logo
- Handle: @iamlespa
- Social icons: LinkedIn, GitHub, Facebook, X, TikTok, Behance, Dribbble
- Year (auto-updating)
- "Built with" line: mentions the stack used to build the site itself
